# Test Results — 20260303T031904

**Models:** minimax-m2.1, minimax-m2.5, glm-4.6, nemotron-3-nano:30b, glm-5, glm-4.7, qwen3-coder-next, qwen3-coder:480b
...
| minimax-m2.5 | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | FAIL (text) |
| glm-4.6 | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | FAIL (text) |
| nemotron-3-nano:30b | PASS (native) | PASS (native) | PASS (native) | FAIL (native) | PASS (native) | PASS (native) | FAIL (text) |
| glm-5 | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | FAIL (text) |
| glm-4.7 | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | FAIL (text) |
| qwen3-coder-next | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | FAIL (text) |
| qwen3-coder:480b | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | FAIL (text) |
...
| Model | single_tool | multi_tool | parallel_calls | multi_step | tool_count_scaling | voxel_tools | voxel_tools_text |
|-------|------|------|------|------|------|------|------|
| minimax-m2.1 | PPPP | PPPP | PPPP | PPPP | PPPP | PPPP | PPPP |
| minimax-m2.5 | PPPP | PPPP | PPPP | PPPP | PPPP | PPPP | PFFF |
| glm-4.6 | PPPP | PPPP | PPPP | PPPP | PPPP | PPPP | FFFF |
| nemotron-3-nano:30b | PPPP | PPPP | PPPP | PPFP | PPPP | PPPP | FFFF |
...
### minimax-m2.1 / voxel_tools_text [S0T1] — PASS
- Classification: text
- Parse success: True
- Stream: False, Think: True
- Notes: All 5 sub-checks passed
...
### minimax-m2.1 / voxel_tools_text [S1T0] — PASS
- Classification: text
- Parse success: True
- Stream: True, Think: False
- Notes: All 5 sub-checks passed
...
### minimax-m2.1 / voxel_tools_text [S1T1] — PASS
- Classification: text
- Parse success: True
- Stream: True, Think: True
- Notes: All 5 sub-checks passed
...
### minimax-m2.5 / voxel_tools_text [S0T0] — PASS
- Classification: text
- Parse success: True
- Stream: False, Think: False
- Notes: All 5 sub-checks passed
...
### minimax-m2.5 / voxel_tools_text [S1T0] — FAIL
- Classification: text
- Parse success: True
- Stream: True, Think: False
- Notes: Failed: zero_param_tool
...
- Stream: False, Think: False
- Notes: Successful turns: 5/5; Turn formats: ['native', 'native', 'native', 'native', 'native']
- Details: {'turn_formats': ['native', 'native', 'native', 'native', 'native'], 'format_switched': False, 'successful_turns': 5, 'turns': [{'turn': 1, 'city': 'Tokyo', 'classification': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'content_preview': "I'll get the current weather information for Tokyo."}, {'turn': 2, 'city': 'Paris', 'classification': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'content_preview': ''}, {'turn': 3, 'city': 'New York', 'classification': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'content_preview': ''}, {'turn': 4, 'city': 'London', 'classification': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'content_preview': ''}, {'turn': 5, 'city': 'Sydney', 'classification': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'content_preview': ''}]}
...
### nemotron-3-nano:30b / multi_step [S1T0] — FAIL
- Classification: native
- Parse success: True
- Stream: True, Think: False
- Notes: Successful turns: 4/5; Turn formats: ['native', 'native', 'native', 'none', 'native']
- Details: {'turn_formats': ['native', 'native', 'native', 'none', 'native'], 'format_switched': False, 'successful_turns': 4, 'turns': [{'turn': 1, 'city': 'Tokyo', 'classification': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'content_preview': ''}, {'turn': 2, 'city': 'Paris', 'classification': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'content_preview': ''}, {'turn': 3, 'city': 'New York', 'classification': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'content_preview': ''}, {'turn': 4, 'city': 'London', 'classification': 'none', 'num_tool_calls': 0, 'tool_names': [], 'content_preview': "The current weather in London is **Cloudy, 16°C**. Let me know if you'd like details about another city! ☔"}, {'turn': 5, 'city': 'Sydney', 'classification': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'content_preview': ''}]}
...
- Stream: False, Think: False
- Notes: All 5 sub-checks passed
- Details: {'tool_selection': {'passed': True, 'notes': "placeBlock({'y': 0, 'x': 3, 'z': 5, 'type': 'stone'}) via native"}, 'enum_adherence': {'passed': True, 'notes': "placeBlock({'type': 'gold', 'x': 7, 'z': 7, 'y': 1}) via native"}, 'integer_constraints': {'passed': True, 'notes': "placeBlock({'type': 'stone', 'x': 15, 'y': 15, 'z': 15}) via native"}, 'zero_param_tool': {'passed': True, 'notes': 'getWorldState({}) via native'}, 'tool_discrimination': {'passed': True, 'notes': "removeBlock({'x': 3, 'y': 0, 'z': 5}) via native"}}
...
- Stream: True, Think: True
- Notes: All 5 sub-checks passed
- Details: {'tool_selection': {'passed': True, 'notes': "placeBlock({'z': 5, 'x': 3, 'y': 0, 'type': 'stone'}) via native"}, 'enum_adherence': {'passed': True, 'notes': "placeBlock({'x': 7, 'y': 1, 'z': 7, 'type': 'gold'}) via native"}, 'integer_constraints': {'passed': True, 'notes': "placeBlock({'y': 15, 'x': 15, 'z': 15, 'type': 'stone'}) via native"}, 'zero_param_tool': {'passed': True, 'notes': 'getWorldState({}) via native'}, 'tool_discrimination': {'passed': True, 'notes': "removeBlock({'x': 3, 'y': 0, 'z': 5}) via native"}}
...
- Details: {'tool_selection': {'passed': True, 'notes': "placeBlock({'x': 3, 'y': 0, 'z': 5, 'type': 'stone'}) via text"}, 'enum_adherence': {'passed': False, 'notes': 'error: ResponseError: Internal Server Error (status code: 500)'}, 'integer_constraints': {'passed': True, 'notes': "placeBlock({'x': 15, 'y': 15, 'z': 15, 'type': 'stone'}) via text"}, 'zero_param_tool': {'passed': False, 'notes': 'no tool calls (none)'}, 'tool_discrimination': {'passed': True, 'notes': "removeBlock({'x': 3, 'y': 0, 'z': 5}) via text"}}
...
- Details: {'tool_selection': {'passed': False, 'notes': "schema issues: ['Wrong type for x: expected integer, got str', 'Wrong type for y: expected integer, got str', 'Wrong type for z: expected integer, got str']"}, 'enum_adherence': {'passed': False, 'notes': "schema issues: ['Wrong type for x: expected integer, got str', 'Wrong type for y: expected integer, got str', 'Wrong type for z: expected integer, got str']"}, 'integer_constraints': {'passed': False, 'notes': "schema issues: ['Wrong type for x: expected integer, got str', 'Wrong type for z: expected integer, got str', 'Wrong type for y: expected integer, got str']"}, 'zero_param_tool': {'passed': False, 'notes': 'error: ResponseError: Internal Server Error (status code: 500)'}, 'tool_discrimination': {'passed': False, 'notes': "schema issues: ['Wrong type for x: expected integer, got str', 'Wrong type for y: expected integer, got str', 'Wrong type for z: expected integer, got str']"}}

### nemotron-3-nano:30b / voxel_tools_text [S1T0] — FAIL
- Classification: text
- Parse success: True
- Stream: True, Think: False
- Notes: Failed: tool_selection, enum_adherence, integer_constraints, zero_param_tool
- Details: {'tool_selection': {'passed': False, 'notes': 'no tool calls (none)'}, 'enum_adherence': {'passed': False, 'notes': 'no tool calls (none)'}, 'integer_constraints': {'passed': False, 'notes': 'no tool calls (none)'}, 'zero_param_tool': {'passed': False, 'notes': 'no tool calls (none)'}, 'tool_discrimination': {'passed': True, 'notes': "removeBlock({'x': 3, 'y': 0, 'z': 5}) via text"}}
...
- Details: {'tool_selection': {'passed': False, 'notes': "schema issues: ['Wrong type for y: expected integer, got str', 'Wrong type for x: expected integer, got str', 'Wrong type for z: expected integer, got str']"}, 'enum_adherence': {'passed': False, 'notes': "schema issues: ['Wrong type for x: expected integer, got str', 'Wrong type for y: expected integer, got str', 'Wrong type for z: expected integer, got str']"}, 'integer_constraints': {'passed': False, 'notes': "schema issues: ['Wrong type for x: expected integer, got str', 'Wrong type for y: expected integer, got str', 'Wrong type for z: expected integer, got str']"}, 'zero_param_tool': {'passed': True, 'notes': 'getWorldState({}) via native'}, 'tool_discrimination': {'passed': False, 'notes': "schema issues: ['Wrong type for x: expected integer, got str', 'Wrong type for y: expected integer, got str', 'Wrong type for z: expected integer, got str']"}}
...
- Stream: False, Think: True
- Notes: Failed: tool_selection, enum_adherence, integer_constraints, zero_param_tool, tool_discrimination
- Details: {'tool_selection': {'passed': False, 'notes': 'wrong tool: placeBlock({"x": 3, "y": 0, "z": 5, "type": "stone"}) (expected placeBlock)'}, 'enum_adherence': {'passed': False, 'notes': 'wrong tool: placeBlock({"x": 7, "y": 1, "z": 7, "type": "gold"}) (expected placeBlock)'}, 'integer_constraints': {'passed': False, 'notes': 'wrong tool: placeBlock({"x": 15, "y": 15, "z": 15, "type": "stone"}) (expected placeBlock)'}, 'zero_param_tool': {'passed': False, 'notes': 'wrong tool: getWorldState{} (expected getWorldState)'}, 'tool_discrimination': {'passed': False, 'notes': 'wrong tool: {"name": "removeBlock", "arguments": {"x": 3, "y": 0, "z": 5}} (expected removeBlock)'}}
...
- Stream: True, Think: False
- Notes: Failed: tool_selection, enum_adherence, integer_constraints, zero_param_tool, tool_discrimination
- Details: {'tool_selection': {'passed': False, 'notes': 'error: ResponseError: Internal Server Error (status code: -1)'}, 'enum_adherence': {'passed': False, 'notes': 'wrong tool: {"name": "placeBlock", "arguments": {"x": 7, "y": 1, "z": 7, "type": "gold"}} (expected placeBlock)'}, 'integer_constraints': {'passed': False, 'notes': 'wrong tool: placeBlock {"x": 15, "y": 15, "z": 15, "type": "stone"} (expected placeBlock)'}, 'zero_param_tool': {'passed': False, 'notes': 'error: ResponseError: Internal Server Error (status code: -1)'}, 'tool_discrimination': {'passed': False, 'notes': 'wrong tool: {"name": "removeBlock", "arguments": {"x": 3, "y": 0, "z": 5}} (expected removeBlock)'}}
...
- Stream: True, Think: True
- Notes: Failed: tool_selection, enum_adherence, integer_constraints, zero_param_tool, tool_discrimination
- Details: {'tool_selection': {'passed': False, 'notes': 'no tool calls (none)'}, 'enum_adherence': {'passed': False, 'notes': 'wrong tool: {"name": "placeBlock", "arguments": {"x": 7, "y": 1, "z": 7, "type": "gold"}} (expected placeBlock)'}, 'integer_constraints': {'passed': False, 'notes': 'wrong tool: placeBlock({"x": 15, "y": 15, "z": 15, "type": "stone"}) (expected placeBlock)'}, 'zero_param_tool': {'passed': False, 'notes': 'no tool calls (none)'}, 'tool_discrimination': {'passed': False, 'notes': 'no tool calls (none)'}}
...
- Stream: False, Think: False
- Notes: Failed: tool_selection, enum_adherence, integer_constraints, zero_param_tool, tool_discrimination
- Details: {'tool_selection': {'passed': False, 'notes': 'error: ResponseError: Service Temporarily Unavailable (status code: 503)'}, 'enum_adherence': {'passed': False, 'notes': 'error: ResponseError: Internal Server Error (status code: 500)'}, 'integer_constraints': {'passed': False, 'notes': 'error: ResponseError: Service Temporarily Unavailable (status code: 503)'}, 'zero_param_tool': {'passed': False, 'notes': 'error: ResponseError: Internal Server Error (status code: 500)'}, 'tool_discrimination': {'passed': False, 'notes': 'error: ResponseError: Internal Server Error (status code: 500)'}}
