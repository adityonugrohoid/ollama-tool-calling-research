...
**Tests:** test_single_tool, test_multi_tool, test_parallel_calls, test_multi_step, test_streaming_tools, test_tool_count_scaling, test_thinking_with_tools, test_text_fallback

| Model | test_single_tool | test_multi_tool | test_parallel_calls | test_multi_step | test_streaming_tools | test_tool_count_scaling | test_thinking_with_tools | test_text_fallback |
|-------|------|------|------|------|------|------|------|------|
| ministral-3:3b | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (text) |
| gemma3:4b | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | PASS (text) |
| ministral-3:8b | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (text) |
| rnj-1:8b | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (text) |
| gemma3:12b | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | PASS (text) |
| gpt-oss:20b | PASS (native) | PASS (native) | FAIL (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | FAIL (text) |
| ministral-3:14b | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (text) |
| devstral-small-2:24b | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (native) | PASS (text) |
| gemma3:27b | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | FAIL (none) | PASS (text) |
...
### gpt-oss:20b / test_multi_step — PASS
- Format: native
- Parse success: True
- Notes: Successful turns: 5/5; Turn formats: ['native', 'native', 'native', 'native', 'native']
- Details: {'turn_formats': ['native', 'native', 'native', 'native', 'native'], 'format_switched': False, 'successful_turns': 5, 'turns': [{'turn': 1, 'city': 'Tokyo', 'format': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'raw_content_preview': ''}, {'turn': 2, 'city': 'Paris', 'format': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'raw_content_preview': ''}, {'turn': 3, 'city': 'New York', 'format': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'raw_content_preview': ''}, {'turn': 4, 'city': 'London', 'format': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'raw_content_preview': ''}, {'turn': 5, 'city': 'Sydney', 'format': 'native', 'num_tool_calls': 1, 'tool_names': ['get_weather'], 'raw_content_preview': ''}]}
...
- Format: native
- Parse success: True
- Notes: Thinking: 76 chars
- Details: {'has_thinking': True, 'thinking_length': 76, 'tool_name': 'get_weather', 'arguments': {'city': 'Tokyo'}, 'corruption_detected': False, 'source': 'native'}
...
- Parse success: False
- Notes: No tool calls in any turn; Successful turns: 0/5; Turn formats: ['none', 'none', 'none', 'none', 'none']
- Details: {'turn_formats': ['none', 'none', 'none', 'none', 'none'], 'format_switched': False, 'successful_turns': 0, 'turns': [{'turn': 1, 'city': 'Tokyo', 'format': 'none', 'num_tool_calls': 0, 'tool_names': [], 'raw_content_preview': 'The weather in Tokyo right now (as of November 21, 2023, at 1:30 PM JST) is:\n\n* **Temperature:** 13°C (55°F)\n* **Condition:** Cloudy\n* **Wind:** Light breeze from the North at 6 km/h\n* **Humidity:** 6'}, {'turn': 2, 'city': 'Paris', 'format': 'none', 'num_tool_calls': 0, 'tool_names': [], 'raw_content_preview': 'The weather in Paris right now (as of November 21, 2023, at 1:45 PM CET) is:\n\n* **Temperature:** 10°C (50°F)\n* **Condition:** Cloudy\n* **Wind:** Moderate breeze from the West at 29 km/h\n* **Humidity:*'}, {'turn': 3, 'city': 'New York', 'format': 'none', 'num_tool_calls': 0, 'tool_names': [], 'raw_content_preview': 'The weather in New York City right now (as of November 21, 2023, at 2:00 PM EST) is:\n\n* **Temperature:** 8°C (46°F)\n* **Condition:** Cloudy\n* **Wind:** West at 24 km/h (15 mph)\n* **Humidity:** 68%\n* *'}, {'turn': 4, 'city': 'London', 'format': 'none', 'num_tool_calls': 0, 'tool_names': [], 'raw_content_preview': 'The weather in London right now (as of November 21, 2023, at 2:15 PM GMT) is:\n\n* **Temperature:** 7°C (45°F)\n* **Condition:** Cloudy\n* **Wind:** West at 32 km/h (20 mph)\n* **Humidity:** 78%\n* **Visibi'}, {'turn': 5, 'city': 'Sydney', 'format': 'none', 'num_tool_calls': 0, 'tool_names': [], 'raw_content_preview': 'The weather in Sydney, Australia right now (as of November 21, 2023, at 2:30 PM AEDT) is:\n\n* **Temperature:** 24°C (75°F)\n* **Condition:** Partly Cloudy\n* **Wind:** South-East at 29 km/h (18 mph)\n* **'}]}
